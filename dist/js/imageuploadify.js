    ...
    this.each(function() {
      ...
      <div class="imageuploadify well">
        ...
        <div class="imageuploadify-images-list text-center">
          ...
          <span class='imageuploadify-message'>Drag & Drop Your File(s) Here To OCR</span>
          <button type="button" class="btn btn-primary">or select file to upload</button>
        </div>
      </div>
      `);
      ...
      const readingFile = (id, file) => {
        ...
        let container = $(`<div class='imageuploadify-container'>
          <button type='button' class='btn btn-danger ti-close'></button><br/>
          <button type='button' class='btn btn-primary tag-btn ti-tag'></button>
        </div>`);
